    ...
    rgba(0, 0, 0, 0.5275297619047619) 100%
      ...
      >
        <div className="studio-heading-container">
          ...
          <h1 className="studio-page-heading">Studio Sunčana dolina</h1>
          ...
          <div className="studio-columns">
            ...
            <div className="studio-column-40">
              <div className="studio-inner-column">
                ...
                <h1 className="studio-inner-heading">Studion Sunčana dolina</h1>
              </div>
              ...
              <p className="studio-total-square">Ukupno 24 m²</p>
