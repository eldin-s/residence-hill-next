    ...
    <div className="studio-single">
      ...
      >
        <div className="studio-heading-container">
          ...
          <h1 className="studio-page-heading">Studio Pančićev vrh</h1>
          ...
          <div className="studio-columns">
            ...
            <div className="studio-column-40">
              <div className="studio-inner-column">
                ...
                <h1 className="studio-inner-heading">Studio Pančićev vrh</h1>
              </div>
              <div className="card-apartment-info">
                ...
                <div className="studio-card-details-container">
                  <div className="card-details">
                    ...
                    <p className="card-detail-description">Spavaća soba</p>
                  </div>
                  <div className="card-detail-squared">8 m²</div>
                </div>
                ...
                <div className="studio-card-details-container">
                  ...
                  <div className="card-detail-squared">6 m²</div>
                </div>
              ...
              <p className="studio-total-square">Ukupno 40 m²</p>
