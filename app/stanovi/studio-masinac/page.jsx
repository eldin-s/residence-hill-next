    ...
    <div className="studio-single">
      ...
      >
        <div className="studio-heading-container">
          ...
          <h1 className="studio-page-heading">Studio Mašinac</h1>
          ...
          <div className="studio-columns">
            ...
            <div className="studio-column-40">
              <div className="studio-inner-column">
                ...
                <h1 className="studio-inner-heading">Studion Mašinac</h1>
              </div>
              ...
              <p className="studio-total-square">Ukupno 22 m²</p>
